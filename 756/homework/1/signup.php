...
{
    /* Database stuff! Get the new user in there. */
    /* ERRORs = Let them know */
    ...
    $user = new MemberForm( $_POST['username'], $_POST['password'],
        $_POST['confirmPassword'], $_POST['first_name'], $_POST['last_name'],
        $_POST['email'], time(), 0, NEW_USER_ENABLED );
...
<?php
echo templateHead( 'Sign Up', array ( 'css/lib/perfect-scrollbar.min.css', 'css/formStyle.css' ), 
        array ( 'js/SignupWidget.js' ) );
?>
    ...
    <div id='content'>
        ...
        <form id='signupForm' method='POST'>
            ...
            <p>
                ...
                <input id='username' type='text' maxlength='16' name='username' placeholder='username'
            ...
            <p>
                ...
                <input id='confirmPassword' type='password' name='confirmPassword' placeholder='same password' />
            </p>
            <div id='formButtons'>
                <p>
