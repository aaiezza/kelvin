...
//Usually you do not want this file under the web root so it can't be accessed from HTTP Clients
...
//$url with expecting post data, $data is array of "key"=>"value" s for post
//$cookiefile is file for cookies like in sendCookies, $cookies are any additional cookies to set
